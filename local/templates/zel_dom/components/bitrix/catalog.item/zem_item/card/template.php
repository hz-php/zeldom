 ...
 */
?>
<a class="card__pic" href="goods.html"> <img src="<?= SITE_TEMPLATE_PATH ?>/img/catalog/pic-2-4.png" width="382" height="253" alt=""><span class="card__werk"><i><img src="<?= SITE_TEMPLATE_PATH ?>/img/svg/werk.svg" width="22" height="22" alt=""></i><span>Syngenta (Швейцария)</span></span></a>
<div class="card__desc"><a class="card__title" title="Фарао F1 (Farao F1) семена арбуза" href="goods.html">Фарао F1 (Farao F1) семена арбуза</a>
    <div class="card__sizes-box"><span class="card__sizes-label">Фасовка:</span>
        <ul class="card__sizes">
            <li>
                <label class="card__size">
                    <input type="radio" name="good-count-7" value="100 гр" checked><i class="card__size-check"></i><span class="card__size-value">100 гр</span>
                </label>
            </li>
            <li>
                <label class="card__size">
                    <input type="radio" name="good-count-7" value="500 гр" disabled><i class="card__size-check"></i><span class="card__size-value">500 гр</span>
                </label>
            </li>
            <li>
                <label class="card__size">
                    <input type="radio" name="good-count-7" value="1 кг"><i class="card__size-check"></i><span class="card__size-value">1 кг</span>
                </label>
            </li>
        </ul>
    </div>
    ...
    <div class="card__bottom">
        <div class="card__counter">
            <div class="counter">
                <button class="counter__btn" type="button" aria-label="Минус" data-type="minus" disabled></button>
                <input class="counter__inp" type="text" name="good-count" inputmode="numeric" value="1" placeholder="0">
                <button class="counter__btn" type="button" aria-label="Плюс" data-type="plus"></button>
            </div>
        </div>
        <div class="card__adds js-cart-add">
            <div class="card__adds-1 js-cart-box-1">
                <buttom class="btn1 card__btn card__add js-cart-btn1" type="button"><span>В корзину</span><i class="btn1__arr">
                        <svg width="40" height="26" xmlns="http://www.w3.org/2000/svg">
                            <use xlink:href="img/svg/btn-cart.svg#q"></use>
                        </svg>
                    </i></buttom>
            </div>
            <div class="card__adds-2 js-cart-box-2"><a class="btn1 btn1_v2 card__btn card__add-3" href="cart.html"><span>В корзину</span><i class="btn1__arr">
                        <svg width="40" height="26" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                            <use xlink:href="img/svg/btn-arrow-2.svg#q"></use>
                        </svg>
                    </i></a><span class="btn1 btn1_v2 card__btn card__add-2"><span>Добавлено</span><i class="btn1__arr"><svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 13.2667L12 17L20 9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></i></span></div>
        </div>
    </div>
</div>
<div class="card__btns">
    <a class="square-btn" href="#" data-type-btn="default">
        <svg width="40" height="40" xmlns="http://www.w3.org/2000/svg">
            <use xlink:href="img/svg/weight-2.svg#q"></use>
        </svg>
    </a><a class="square-btn" href="#" data-type-btn="favorite-fill" data-check="true">
        <svg width="40" height="40" xmlns="http://www.w3.org/2000/svg">
            <use xlink:href="img/svg/heart-2.svg#q"></use>
        </svg>
    </a>
</div>
