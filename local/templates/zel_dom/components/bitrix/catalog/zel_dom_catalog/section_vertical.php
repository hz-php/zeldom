...
<div class="top__wrap-2">
    <div class="top__wrap-2-2"><a class="top__link-back" href="catalog.html">
            <svg width="44" height="44" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <use xlink:href="img/svg2/arrow-page-back.svg#q"></use>
            </svg>
        </a>
        <h1 class="top__title-2" data-aos="fade-right" data-aos-delay="50">Семена арбузов</h1>
    </div>
</div>
<div class="catalog catalog_v2" id="catalog">
    <div class="catalog__row-1">
