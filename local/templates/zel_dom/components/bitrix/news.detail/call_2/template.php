                ...
                <div class="call__socials">
                    <ul class="socials">
                        <li data-aos="fade" data-aos-delay="0">
                            <a class="socials__link" href="tel:<?= $arResult['PROPERTIES']['NUMBERS']['VALUE'][0] ?>" target="_blank" rel="noopener noreferrer" data-type="phone">
                        ...
                        <li data-aos="fade" data-aos-delay="100">
                            <a class="socials__link" href="https://wa.me/<?= $arResult['PROPERTIES']['NUMBERS']['VALUE'][1] ?>" target="_blank" rel="noopener noreferrer" data-type="whatsapp">
                        ...
                        <li data-aos="fade" data-aos-delay="200">
                            <a class="socials__link" href="https://t.me/<?= $arResult['PROPERTIES']['NUMBERS']['VALUE'][2] ?>" target="_blank" rel="noopener noreferrer" data-type="telegram">
