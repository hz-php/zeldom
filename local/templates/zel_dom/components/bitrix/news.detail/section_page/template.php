...
<div class="call__desc">
    <h2 class="call__title" data-aos="fade-right" data-aos-delay="0"><?= $arResult['NAME']?></h2>
        ...
        <div class="call__socials">
            <ul class="socials">
                <li data-aos="fade" data-aos-delay="0">
                    <a class="socials__link" href="tel:<?= $arResult['PROPERTIES']['PHONE']['VALUE']?>" target="_blank" rel="noopener noreferrer" data-type="phone">
                ...
                <li data-aos="fade" data-aos-delay="100">
                    <a class="socials__link" href="https://wa.me/<?= $arResult['PROPERTIES']['WHATSAP']['VALUE']?>" target="_blank" rel="noopener noreferrer" data-type="whatsapp">
                ...
                <li data-aos="fade" data-aos-delay="200">
                    <a class="socials__link" href="https://t.me/<?= $arResult['PROPERTIES']['TELEGA']['VALUE']?>" target="_blank" rel="noopener noreferrer" data-type="telegram">
