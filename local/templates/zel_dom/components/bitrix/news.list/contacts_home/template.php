...
<ul class="socials">
    <?php
    foreach ($arResult['ITEMS'][0]['PROPERTIES']['PHONES']['VALUE'] as $phone) {
        ?>
        <li data-aos="fade" data-aos-delay="0">
            <a class="socials__link" href="tel:<?= $phone ?>" target="_blank" rel="noopener noreferrer" data-type="phone">
    ...
    foreach ($arResult['ITEMS'][0]['PROPERTIES']['NUMBERS_WHATS']['VALUE'] as $whatsappNumber) {
        ?>
        <li data-aos="fade" data-aos-delay="100">
            <a class="socials__link" href="https://wa.me/<?= $whatsappNumber ?>" target="_blank" rel="noopener noreferrer" data-type="whatsapp">
                <img src="<?= SITE_TEMPLATE_PATH ?>/img/svg/whatsapp-2.svg" width="57" height="57" alt="WhatsApp">
            </a>
        </li>
        <?php
    }
    foreach ($arResult['ITEMS'][0]['PROPERTIES']['NUMBERS_TEL']['VALUE'] as $telNumber) {
        ?>
        <li data-aos="fade" data-aos-delay="200">
            <a class="socials__link" href="https://t.me/<?= $telNumber?>" target="_blank" rel="noopener noreferrer" data-type="telegram">
